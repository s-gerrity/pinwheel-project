...
if __name__ == '__main__':
    test_valid_years_and_formatting()
    test_next_page_year_grouping()
    test_not_all_years_available()
    test_lowercase_form_input()
    test_uppercase_form_input()
    test_missing_dash_form_input()
    test_misspelled_form_input()